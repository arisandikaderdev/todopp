...
<script>
    ...
    const selectTodo = document.querySelectorAll('.todo-select');
    let countChecked = 0;
    ...
    for (const input of selectTodo) {
        input.addEventListener('click', () => {
            countChecked = 0;
            for (const inputCheck of selectTodo) {
            ...
            if (countChecked == 0) {
                ...
                trash.classList.add('hidden');
            } else if (countChecked == selectTodo.length) {
